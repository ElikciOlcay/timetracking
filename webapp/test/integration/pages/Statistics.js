			...
			assertions: {
				...
				iShouldSeeTheCharts: function () {
					if (sChartViewName.search("D3") >= 0) {
						this.waitFor({
							controlType: "ks.it.timetracking.control.D3PieChart",
							viewName: sChartViewName,
						...
						this.waitFor({
							controlType: "ks.it.timetracking.control.D3ColumnChart",
							viewName: sChartViewName,
							success: function (aCharts) {
						...
						this.waitFor({
							controlType: "ks.it.timetracking.control.D3ComparisonChart",
							viewName: sChartViewName,
							success: function (aCharts) {
						...
						this.waitFor({
							controlType: "ks.it.timetracking.control.D3Chart",
							viewName: sChartViewName,
							success: function (aCharts) {
